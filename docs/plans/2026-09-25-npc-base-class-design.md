...
> ⚠️ **本文档的 D46（冲刺复位）与 D47（走路档位 1.0）已被取代（2026-09-25，用户裁定 Q1）。**
> 移动改为原版刻度、取消奔跑状态 —— 见 **`docs/plans/2026-09-25-npc-vanilla-ai-design.md`**。
> 同批被修订的还有 `2026-09-25-dihuang-loong-ai-design.md` 的 **D21 / D25**。
> 本文档其余决策（尤其 D32–D44）**继续有效**。
